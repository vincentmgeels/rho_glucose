...
#extract a day (or days) of interest given the visit (via device_visit_period_day column)
...
length.days <- 3 #number of days to extract at the visit level
...
ex <- current.df %>% complete(nesting(pt_id,trt_group,visitnum,device_visit_period_day), device_tm_bin = seq(1,288, 1L))
